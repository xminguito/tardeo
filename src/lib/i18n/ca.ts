...
export default {
  ...
  home: {
    ...
    dashboard: {
      ...
      headline: 'Hola {{name}}, tens plans!',
      nextEvent: 'Pròxim event',
      today: 'Avui a les {{time}}',
      tomorrow: 'Demà a les {{time}}',
      inDays: 'En {{count}} dia',
      inDays_plural: 'En {{count}} dies',
      goToChat: 'Anar al Xat',
      viewDetails: 'Veure detalls',
      moreActivities: '+{{count}} activitat més',
      moreActivities_plural: '+{{count}} activitats més',
      viewAllActivities: "Veure totes les meves activitats ({{count}})",
    },
  },
  auth: {
  ...
  activities: {
    ...
    create: {
      ...
      locationAutocompletePlaceholder: 'Cercar lloc, restaurant, local...',
      locationNotFound: 'No s\'ha pogut obtenir la ubicació. Prova amb una altra cerca.',
    ...
    categories: {
      social: 'Social',
      culture: 'Art i Cultura',
      sport: 'Esport i Salut',
      food: 'Gastronomia',
      music: 'Música i Ball',
      games: 'Jocs',
  ...
  communities: {
    ...
    activities: "Activitats",
    activity_count: "{{count}} activitat",
    activity_count_plural: "{{count}} activitats",
    about: "Sobre",
    empty: "Encara no hi ha comunitats",
    emptyDescription: "Sigues el primer a crear una comunitat per connectar amb persones que comparteixen els teus interessos",
    ...
    detail: {
      joinConfirm: "Unir-se a {{name}}?",
      joinDescription: "Podràs veure activitats exclusives i connectar amb altres membres",
      leaveConfirm: "Sortir de {{name}}?",
      leaveDescription: "Deixaràs de veure les activitats exclusives d'aquesta comunitat",
      organizedBy: "Organitzat per",
      noActivities: "No hi ha activitats properes",
      noActivitiesDescription: "Aquesta comunitat encara no té activitats programades",
      noMembers: "Encara no hi ha membres",
      joinSuccess: "T'has unit a {{name}}",
      leaveSuccess: "Has sortit de {{name}}",
      joinError: "No s'ha pogut unir a la comunitat",
      leaveError: "No s'ha pogut sortir de la comunitat",
      tabs: {
        activities: "Activitats",
        members: "Membres",
        about: "Informació",
    ...
    createForm: {
      title: "Crear Nova Comunitat",
      description: "Crea un espai per reunir persones amb interessos comuns",
      name: "Nom de la comunitat",
      namePlaceholder: "ex: Amants del Ioga a Barcelona",
      slug: "URL amigable",
      slugPlaceholder: "amants-ioga-barcelona",
      slugHelp: "S'utilitzarà a la URL: tardeo.com/communities/{{slug}}",
      slugAvailable: "Disponible!",
      slugTaken: "Aquest slug ja està en ús",
      descriptionLabel: "Descripció",
      descriptionPlaceholder: "De què tracta la teva comunitat? Quines activitats organitzareu?",
      category: "Categoria principal",
      categoryPlaceholder: "Selecciona una categoria",
      tags: "Etiquetes",
      tagsPlaceholder: "ioga, meditació, benestar",
      tagsHelp: "Separa les etiquetes amb comes",
      coverImage: "Imatge de portada (opcional)",
      coverImagePlaceholder: "URL de la imatge",
      avatar: "Logo/Avatar (opcional)",
      avatarPlaceholder: "URL del logo",
      privacy: "Privacitat",
      public: "Pública - Qualsevol pot veure i unir-se",
      private: "Privada - Només per invitació",
      submit: "Crear Comunitat",
      submitting: "Creant...",
      success: "Comunitat creada!",
      successDescription: "Ja pots començar a convidar membres i crear activitats",
      error: "Error en crear la comunitat",
