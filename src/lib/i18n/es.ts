export default {
  ...
  auth: {
    ...
    enterPhone: 'Ingresa tu número de teléfono para continuar',
    sendCode: 'Enviar código',
    otpSent: 'Código enviado',
    otpSentDesc: 'Revisa tu teléfono para ver el código de verificación',
    verificationCode: 'Código de verificación',
    otpInvalid: 'El código debe tener 6 dígitos',
    otpHint: 'Ingresa el código de 6 dígitos que recibiste',
    verify: 'Verificar',
